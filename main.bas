...
if aa$<>bb$ AND code(aa$)>0
	...
	if (tecla=49 OR tecla=50 OR tecla=51) ' 1,2 o 3 Seleccionar rotor
		pintaRingSet(0)
	...
	if (tecla=52 OR tecla=53 OR tecla=54) ' 4,5,6 rotar rotores forward
		pintaRingSet(0)	
		moveRotor(tecla-52,0,1)
		saveStartingPos()
		click()
	end if
	
	if (tecla=5)   'MAYS+4 Rotar rotor 0 backwards
		pintaRingSet(0)
		moveRotor(0,1,1)
		saveStartingPos()
		click()
	...
	if (tecla=8) 'MAYS+5 Rotar rotor 1 backwards
		pintaRingSet(0)
		moveRotor(1,1,1)
		saveStartingPos()
		click()
	...
	if (tecla=10) ' MAYS+6 Rotar rotor 2 backwards
		pintaRingSet(0)
		moveRotor(2,1,1)
		saveStartingPos()
		click()
...
sub inicializaPantalla()
	...
	pintaLetrasPlugs()
	ink 6
	printat42(19,30):print42("Enter=Help")
	bright 0
end sub
